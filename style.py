def mpl_apply():
    ...
    # If not system-installed, add the TTF explicitly:
    # font_manager.fontManager.addfont("/path/to/CormorantGaramond-Regular.ttf")
    # font_manager.fontManager.addfont("/path/to/CormorantGaramond-Bold.ttf")
    # font_manager.fontManager.addfont("/path/to/CormorantGaramond-Italic.ttf")
